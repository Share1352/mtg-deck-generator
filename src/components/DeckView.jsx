...
export default function DeckView({ deck, onAgain }) {
  ...
  return h('main', { className: 'deck-view' },
    ...
    h('section', null, h('h2', null, 'On-theme cards (60%)'), h(CardGrid, { cards: deck.themeCards || deck.core })),
    h('section', null, h('h2', null, 'Theme support package (40%)'), h(CardGrid, { cards: deck.supportCards || deck.random })),
